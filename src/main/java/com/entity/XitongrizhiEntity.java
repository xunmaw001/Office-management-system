...
public class XitongrizhiEntity<T> implements Serializable {
	 ...
	 * 设置：日志名称
	 */
	public void setRizhimingcheng(String rizhimingcheng) {
		this.rizhimingcheng = rizhimingcheng;
	}
	/**
	 * 获取：日志名称
	 */
	public String getRizhimingcheng() {
		return rizhimingcheng;
	}
	/**
	 * 设置：日志内容
	 */
