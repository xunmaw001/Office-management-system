...
public class BangongyongpinController {
    ...
    public R save(@RequestBody BangongyongpinEntity bangongyongpin, HttpServletRequest request){
    	bangongyongpin.setId(new Date().getTime()+new Double(Math.floor(Math.random()*1000)).longValue());
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<BangongyongpinEntity> wrapper = new EntityWrapper<BangongyongpinEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = bangongyongpinService.selectCount(wrapper);
