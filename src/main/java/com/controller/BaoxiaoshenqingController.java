...
public class BaoxiaoshenqingController {
    ...
    public R page(@RequestParam Map<String, Object> params,BaoxiaoshenqingEntity baoxiaoshenqing, 
                @RequestParam(required = false) @DateTimeFormat(pattern="yyyy-MM-dd") Date baoxiaoriqistart,
                @RequestParam(required = false) @DateTimeFormat(pattern="yyyy-MM-dd") Date baoxiaoriqiend,
		HttpServletRequest request){

		String tableName = request.getSession().getAttribute("tableName").toString();
		if(tableName.equals("xiangmuguanli")) {
			baoxiaoshenqing.setGuanlizhanghao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("yonghu")) {
			baoxiaoshenqing.setZhanghao((String)request.getSession().getAttribute("username"));
		}
        EntityWrapper<BaoxiaoshenqingEntity> ew = new EntityWrapper<BaoxiaoshenqingEntity>();
                if(baoxiaoriqistart!=null) ew.ge("baoxiaoriqi", baoxiaoriqistart);
                if(baoxiaoriqiend!=null) ew.le("baoxiaoriqi", baoxiaoriqiend);
