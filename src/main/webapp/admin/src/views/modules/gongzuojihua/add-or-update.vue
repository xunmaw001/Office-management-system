    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="计划方案" prop="jihuafangan">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="计划方案"
                  v-model="ruleForm.jihuafangan" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.jihuafangan" label="计划方案" prop="jihuafangan">
                    <span>{{ruleForm.jihuafangan}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="预计结果" prop="yujijieguo">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="预计结果"
                  v-model="ruleForm.yujijieguo" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.yujijieguo" label="预计结果" prop="yujijieguo">
                    <span>{{ruleForm.yujijieguo}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jihuaneirong = true;
          ...
          if(o=='jihuafangan'){
            this.ruleForm.jihuafangan = obj[o];
	    this.ro.jihuafangan = true;
            continue;
          }
          if(o=='yujijieguo'){
            this.ruleForm.yujijieguo = obj[o];
	    this.ro.yujijieguo = true;
            continue;
          }
          if(o=='beizhu'){
