<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="用品名称" prop="yongpinmingcheng">
          <el-input v-model="ruleForm.yongpinmingcheng" 
              placeholder="用品名称" clearable  :readonly="ro.yongpinmingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="用品名称" prop="yongpinmingcheng">
              <el-input v-model="ruleForm.yongpinmingcheng" 
                placeholder="用品名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  methods: {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `bangongyongpin/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.bangongyongpinCrossAddOrUpdateFlag = false;
                  this.parent.search();
