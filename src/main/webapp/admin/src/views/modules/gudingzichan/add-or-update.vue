<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="供货商" prop="gonghuoshang">
          <el-input v-model="ruleForm.gonghuoshang" 
              placeholder="供货商" clearable  :readonly="ro.gonghuoshang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="供货商" prop="gonghuoshang">
              <el-input v-model="ruleForm.gonghuoshang" 
                placeholder="供货商" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.gourujine = true;
          ...
          if(o=='gonghuoshang'){
            this.ruleForm.gonghuoshang = obj[o];
	    this.ro.gonghuoshang = true;
            continue;
          }
          if(o=='goururiqi'){
