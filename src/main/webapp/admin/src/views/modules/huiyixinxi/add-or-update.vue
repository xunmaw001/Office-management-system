<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="会议地点" prop="huiyididian">
          <el-input v-model="ruleForm.huiyididian" 
              placeholder="会议地点" clearable  :readonly="ro.huiyididian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="会议地点" prop="huiyididian">
              <el-input v-model="ruleForm.huiyididian" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="重要人员" prop="zhongyaorenyuan">
          <el-input v-model="ruleForm.zhongyaorenyuan" 
              placeholder="重要人员" clearable  :readonly="ro.zhongyaorenyuan"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="重要人员" prop="zhongyaorenyuan">
              <el-input v-model="ruleForm.zhongyaorenyuan" 
                placeholder="重要人员" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="开会时间" prop="kaihuishijian">
            <el-date-picker
                value-format="yyyy-MM-dd HH:mm:ss"
                v-model="ruleForm.kaihuishijian" 
                type="datetime"
                placeholder="开会时间">
            </el-date-picker>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.kaihuishijian" label="开会时间" prop="kaihuishijian">
              <el-input v-model="ruleForm.kaihuishijian" 
                placeholder="开会时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.huiyineirong = true;
          ...
          if(o=='zhongyaorenyuan'){
            this.ruleForm.zhongyaorenyuan = obj[o];
	    this.ro.zhongyaorenyuan = true;
            continue;
          }
          if(o=='xiangqing'){
	    ...
	    this.ro.xiangqing = true;
          ...
          if(o=='kaihuishijian'){
            this.ruleForm.kaihuishijian = obj[o];
	    this.ro.kaihuishijian = true;
            continue;
          }
          if(o=='guanlizhanghao'){
	...
	this.ruleForm.xiangqing = this.ruleForm.xiangqing.replace(reg,'../../../ssm4yvz9/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `huiyixinxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.huiyixinxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
