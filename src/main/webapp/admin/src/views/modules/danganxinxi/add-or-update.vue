<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="档案类型" prop="danganleixing">
          <el-input v-model="ruleForm.danganleixing" 
              placeholder="档案类型" clearable  :readonly="ro.danganleixing"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="填报人" prop="tianbaoren">
          <el-input v-model="ruleForm.tianbaoren" 
              placeholder="填报人" clearable  :readonly="ro.tianbaoren"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="填报人" prop="tianbaoren">
              <el-input v-model="ruleForm.tianbaoren" 
                placeholder="填报人" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="档案内容" prop="danganneirong">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.danganneirong" label="档案内容" prop="danganneirong">
                    <span>{{ruleForm.danganneirong}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.danganwenjian = true;
          ...
          if(o=='tianbaoren'){
            this.ruleForm.tianbaoren = obj[o];
	    this.ro.tianbaoren = true;
            continue;
          }
          if(o=='lurushijian'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `danganxinxi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.danganxinxiCrossAddOrUpdateFlag = false;
                  this.parent.search();
