<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="报销项目" prop="baoxiaoxiangmu">
          <el-input v-model="ruleForm.baoxiaoxiangmu" 
              placeholder="报销项目" clearable  :readonly="ro.baoxiaoxiangmu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="报销项目" prop="baoxiaoxiangmu">
              <el-input v-model="ruleForm.baoxiaoxiangmu" 
                placeholder="报销项目" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="报销日期" prop="baoxiaoriqi">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.baoxiaoriqi" 
                type="date"
                placeholder="报销日期">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.baoxiaoriqi" label="报销日期" prop="baoxiaoriqi">
              <el-input v-model="ruleForm.baoxiaoriqi" 
                placeholder="报销日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="报销内容" prop="baoxiaoneirong">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.baoxiaoneirong" label="报销内容" prop="baoxiaoneirong">
                    <span>{{ruleForm.baoxiaoneirong}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  created() {
	this.ruleForm.baoxiaoriqi = this.getCurDate()
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.beizhu = true;
          ...
          if(o=='baoxiaoriqi'){
            this.ruleForm.baoxiaoriqi = obj[o];
	    this.ro.baoxiaoriqi = true;
            continue;
          }
          if(o=='bumen'){
