<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="借阅时间" prop="jieyueshijian">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.jieyueshijian" label="借阅时间" prop="jieyueshijian">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="借阅目的" prop="jieyuemude">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="借阅目的"
                  v-model="ruleForm.jieyuemude" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.jieyuemude" label="借阅目的" prop="jieyuemude">
                    <span>{{ruleForm.jieyuemude}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jieyueshijian = true;
          ...
          if(o=='jieyuemude'){
            this.ruleForm.jieyuemude = obj[o];
	    this.ro.jieyuemude = true;
            continue;
          }
          if(o=='bumen'){
