<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="文件资料" prop="wenjianziliao">
          <file-upload
          tip="点击上传文件资料"
          action="file/upload"
          :limit="1"
          :multiple="true"
          :fileUrls="ruleForm.wenjianziliao?ruleForm.wenjianziliao:''"
          @change="wenjianziliaoUploadChange"
          ></file-upload>
        </el-form-item>  
        <div v-else>
          <el-form-item v-if="ruleForm.wenjianziliao" label="文件资料" prop="wenjianziliao">
            <el-button type="text" size="small" @click="download(ruleForm.wenjianziliao)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="文件内容" prop="wenjianneirong">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.wenjianneirong" label="文件内容" prop="wenjianneirong">
                    <span>{{ruleForm.wenjianneirong}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.wenjianneirong = true;
          ...
          if(o=='wenjianziliao'){
            this.ruleForm.wenjianziliao = obj[o];
	    this.ro.wenjianziliao = true;
            continue;
          }
          if(o=='faburiqi'){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `gongsifawen/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.gongsifawenCrossAddOrUpdateFlag = false;
                  this.parent.search();
    ...
    wenjianziliaoUploadChange(fileUrls) {
	this.ruleForm.wenjianziliao = fileUrls;
			this.addEditUploadStyleChange()
    },
	addEditStyleChange() {
	  this.$nextTick(()=>{
