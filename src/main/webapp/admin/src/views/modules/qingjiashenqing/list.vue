        ...
        <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
		    ...
		    label="请假天数">
		     <template slot-scope="scope">
                  ...
                  <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign" prop="zhengmingwenjian"
                    header-align="center"
                    label="证明文件">
                    <template slot-scope="scope">
                      <el-button type="text" size="small" @click="download(scope.row.zhengmingwenjian)">下载</el-button>
                    </template>
                  </el-table-column>
                <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                    prop="bumen"
