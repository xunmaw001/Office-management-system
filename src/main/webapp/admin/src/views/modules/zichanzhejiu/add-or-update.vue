<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="购入金额" prop="gourujine">
          <el-input v-model="ruleForm.gourujine" 
              placeholder="购入金额" clearable  :readonly="ro.gourujine"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="购入金额" prop="gourujine">
              <el-input v-model="ruleForm.gourujine" 
                placeholder="购入金额" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="购入日期" prop="goururiqi">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.goururiqi" 
                type="date"
                placeholder="购入日期">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.goururiqi" label="购入日期" prop="goururiqi">
              <el-input v-model="ruleForm.goururiqi" 
                placeholder="购入日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="折旧年限" prop="zhejiunianxian">
          <el-input v-model="ruleForm.zhejiunianxian" 
              placeholder="折旧年限" clearable  :readonly="ro.zhejiunianxian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="折旧年限" prop="zhejiunianxian">
              <el-input v-model="ruleForm.zhejiunianxian" 
                placeholder="折旧年限" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="残值率" prop="canzhilv">
          <el-input v-model="ruleForm.canzhilv" 
              placeholder="残值率" clearable  :readonly="ro.canzhilv"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="残值率" prop="canzhilv">
              <el-input v-model="ruleForm.canzhilv" 
                placeholder="残值率" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="累计折旧" prop="leijizhejiu">
          <el-input v-model="ruleForm.leijizhejiu" 
              placeholder="累计折旧" clearable  :readonly="ro.leijizhejiu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="累计折旧" prop="leijizhejiu">
              <el-input v-model="ruleForm.leijizhejiu" 
                placeholder="累计折旧" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="折旧余额" prop="zhejiuyue">
          <el-input v-model="ruleForm.zhejiuyue" 
              placeholder="折旧余额" clearable  :readonly="ro.zhejiuyue"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="折旧余额" prop="zhejiuyue">
              <el-input v-model="ruleForm.zhejiuyue" 
                placeholder="折旧余额" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="管理账号" prop="guanlizhanghao">
          <el-input v-model="ruleForm.guanlizhanghao" 
              placeholder="管理账号" clearable  :readonly="ro.guanlizhanghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="管理账号" prop="guanlizhanghao">
              <el-input v-model="ruleForm.guanlizhanghao" 
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.guige = true;
          ...
          if(o=='gourujine'){
            this.ruleForm.gourujine = obj[o];
	    this.ro.gourujine = true;
            continue;
          }
          if(o=='goururiqi'){
            this.ruleForm.goururiqi = obj[o];
	    this.ro.goururiqi = true;
            continue;
          }
          if(o=='zhejiunianxian'){
            this.ruleForm.zhejiunianxian = obj[o];
	    this.ro.zhejiunianxian = true;
            continue;
          }
          if(o=='canzhilv'){
            this.ruleForm.canzhilv = obj[o];
	    this.ro.canzhilv = true;
            continue;
          }
          if(o=='leijizhejiu'){
            this.ruleForm.leijizhejiu = obj[o];
	    this.ro.leijizhejiu = true;
            continue;
          }
          if(o=='zhejiuyue'){
            this.ruleForm.zhejiuyue = obj[o];
	    this.ro.zhejiuyue = true;
            continue;
          }
          if(o=='beizhu'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          var json = data.data;
		if(json.guanlizhanghao!=''&&json.guanlizhanghao){
              		this.ruleForm.guanlizhanghao = json.guanlizhanghao
		}
		if(json.guanlixingming!=''&&json.guanlixingming){
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `zichanzhejiu/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.zichanzhejiuCrossAddOrUpdateFlag = false;
                  this.parent.search();
