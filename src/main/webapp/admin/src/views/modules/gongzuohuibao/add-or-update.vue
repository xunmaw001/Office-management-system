<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="汇报名称" prop="huibaomingcheng">
          <el-input v-model="ruleForm.huibaomingcheng" 
              placeholder="汇报名称" clearable  :readonly="ro.huibaomingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="汇报名称" prop="huibaomingcheng">
              <el-input v-model="ruleForm.huibaomingcheng" 
                placeholder="汇报名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="工作周期" prop="gongzuozhouqi">
          <el-input v-model="ruleForm.gongzuozhouqi" 
              placeholder="工作周期" clearable  :readonly="ro.gongzuozhouqi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="工作周期" prop="gongzuozhouqi">
              <el-input v-model="ruleForm.gongzuozhouqi" 
                placeholder="工作周期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="汇报日期" prop="huibaoriqi">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.huibaoriqi" 
                type="date"
                placeholder="汇报日期">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.huibaoriqi" label="汇报日期" prop="huibaoriqi">
              <el-input v-model="ruleForm.huibaoriqi" 
                placeholder="汇报日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="未完成原因" prop="weiwanchengyuanyin">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="未完成原因"
                  v-model="ruleForm.weiwanchengyuanyin" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.weiwanchengyuanyin" label="未完成原因" prop="weiwanchengyuanyin">
                    <span>{{ruleForm.weiwanchengyuanyin}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="解决措施" prop="jiejuecuoshi">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="解决措施"
                  v-model="ruleForm.jiejuecuoshi" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.jiejuecuoshi" label="解决措施" prop="jiejuecuoshi">
                    <span>{{ruleForm.jiejuecuoshi}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	huibaomingcheng : false,
	gongzuoneirong : false,
	gongzuozhouqi : false,
	wanchengqingkuang : false,
	weiwanchengyuanyin : false,
	jiejuecuoshi : false,
	beizhu : false,
	huibaoriqi : false,
	zhanghao : false,
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.guanlixingming = true;
          ...
          if(o=='huibaomingcheng'){
            this.ruleForm.huibaomingcheng = obj[o];
	    this.ro.huibaomingcheng = true;
            continue;
          }
          if(o=='gongzuoneirong'){
	    ...
	    this.ro.gongzuoneirong = true;
          ...
          if(o=='gongzuozhouqi'){
            this.ruleForm.gongzuozhouqi = obj[o];
	    this.ro.gongzuozhouqi = true;
            continue;
          }
	    ...
	    this.ro.wanchengqingkuang = true;
          ...
          if(o=='weiwanchengyuanyin'){
            this.ruleForm.weiwanchengyuanyin = obj[o];
	    this.ro.weiwanchengyuanyin = true;
            continue;
          }
          if(o=='jiejuecuoshi'){
            this.ruleForm.jiejuecuoshi = obj[o];
	    this.ro.jiejuecuoshi = true;
            continue;
          }
          if(o=='beizhu'){
	    ...
	    this.ro.beizhu = true;
          ...
          if(o=='huibaoriqi'){
            this.ruleForm.huibaoriqi = obj[o];
	    this.ro.huibaoriqi = true;
            continue;
          }
          if(o=='zhanghao'){
      ...
      this.$http({
		...
		if(json.xingming!=''&&json.xingming){
          ...
          this.$message.error(data.msg);
            ...
            this.wanchengqingkuangOptions = "完成,未完成".split(',')
    },
    // 下二随
