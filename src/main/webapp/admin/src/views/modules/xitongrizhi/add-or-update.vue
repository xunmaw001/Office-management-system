<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="日志名称" prop="rizhimingcheng">
          <el-input v-model="ruleForm.rizhimingcheng" 
              placeholder="日志名称" clearable  :readonly="ro.rizhimingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="日志名称" prop="rizhimingcheng">
              <el-input v-model="ruleForm.rizhimingcheng" 
                placeholder="日志名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="日志内容" prop="rizhineirong">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.rizhineirong" label="日志内容" prop="rizhineirong">
                    <span>{{ruleForm.rizhineirong}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='rizhimingcheng'){
            this.ruleForm.rizhimingcheng = obj[o];
	    this.ro.rizhimingcheng = true;
            continue;
          }
          if(o=='rizhineirong'){
