  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255, 255, 255, 0.53);borderRadius:10px">
        <h1 class="h1" style="color:rgba(101, 126, 253, 1);fontSize:25px;">OA办公管理系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<el-form-item label="单位名称" class="input" v-if="tableName=='yonghu'">
			...
			<!-- <div v-if="tableName=='xiangmuguanli'" class="input-group">
			   <div class="label">管理账号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.guanlizhanghao" class="input" type="text" placeholder="管理账号">
			   </div>
			 </div> -->
			<el-form-item label="管理账号" class="input" v-if="tableName=='xiangmuguanli'">
			  <el-input v-model="ruleForm.guanlizhanghao" autocomplete="off" placeholder="管理账号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='xiangmuguanli'" class="input-group">
			   <div class="label">密码</div>
			   <div class="input-container">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='xiangmuguanli'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="password"#elsetype="text" />
			</el-form-item>
			<!-- <div v-if="tableName=='xiangmuguanli'" class="input-group">
			...
			<el-form-item label="管理姓名" class="input" v-if="tableName=='xiangmuguanli'">
			...
			<el-form-item label="单位名称" class="input" v-if="tableName=='xiangmuguanli'">
			  <el-input v-model="ruleForm.danweimingcheng" autocomplete="off" placeholder="单位名称"  />
			</el-form-item>
			<!-- <div v-if="tableName=='xiangmuguanli'" class="input-group">
			...
			<el-form-item label="职位" class="input" v-if="tableName=='xiangmuguanli'">
			...
			<el-form-item label="手机" class="input" v-if="tableName=='xiangmuguanli'">
			  <el-input v-model="ruleForm.shouji" autocomplete="off" placeholder="手机"  />
			</el-form-item>
			<!-- <div v-if="tableName=='xiangmuguanli'" class="input-group">
			   <div class="label">邮箱</div>
			...
			<el-form-item label="邮箱" class="input" v-if="tableName=='xiangmuguanli'">
			  <el-input v-model="ruleForm.youxiang" autocomplete="off" placeholder="邮箱"  />
			</el-form-item>
			<!-- <div v-if="tableName=='xiangmuguanli'" class="input-group">
			   <div class="label">身份证</div>
			...
			<el-form-item label="身份证" class="input" v-if="tableName=='xiangmuguanli'">
			  <el-input v-model="ruleForm.shenfenzheng" autocomplete="off" placeholder="身份证"  />
			</el-form-item>
...
export default {
  ...
  methods: {
    ...
    login() {
      ...
      if((!this.ruleForm.guanlizhanghao) && `xiangmuguanli` == this.tableName){
        this.$message.error(`管理账号不能为空`);
        return
      }
      if((!this.ruleForm.mima) && `xiangmuguanli` == this.tableName){
        this.$message.error(`密码不能为空`);
        return
      }
      if((!this.ruleForm.guanlixingming) && `xiangmuguanli` == this.tableName){
        this.$message.error(`管理姓名不能为空`);
        return
      }
      if(`xiangmuguanli` == this.tableName && this.ruleForm.shouji&&(!this.$validate.isMobile(this.ruleForm.shouji))){
        this.$message.error(`手机应输入手机格式`);
        return
      }
      if(`xiangmuguanli` == this.tableName && this.ruleForm.youxiang&&(!this.$validate.isEmail(this.ruleForm.youxiang))){
        this.$message.error(`邮箱应输入邮件格式`);
        return
      }
      if(`xiangmuguanli` == this.tableName && this.ruleForm.shenfenzheng&&(!this.$validate.checkIdCard(this.ruleForm.shenfenzheng))){
        this.$message.error(`身份证应输入身份证格式`);
        return
      }
      this.$http({
